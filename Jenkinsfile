pipeline {
  agent any
  environment {
    PIPELINE_USER_CREDENTIAL_ID = 'AKIATQG2ZJYEMAJECK6B'
    SAM_TEMPLATE = 'template.yaml'
    MAIN_BRANCH = 'main'
    TESTING_STACK_NAME = 'test-dev-stack'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-develop-PipelineExecutionRole-KXMZUI9LIMIK'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-devel-CloudFormationExecutionR-1C3EO7DV68NRI'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-develop-pipel-artifactsbucket-at3zsqm58e2h'
    // If there are functions with "Image" PackageType in your template,
    // uncomment the line below and add "--image-repository ${TESTING_IMAGE_REPOSITORY}" to
    // testing "sam package" and "sam deploy" commands.
    // TESTING_IMAGE_REPOSITORY = '0123456789.dkr.ecr.region.amazonaws.com/repository-name'
    TESTING_REGION = 'us-east-1'
    PROD_STACK_NAME = 'test-prod-stack'
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-producti-PipelineExecutionRole-1XB0NCA9NVG2S'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-produ-CloudFormationExecutionR-1A8MA34RKL6TJ'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-production-pi-artifactsbucket-tnapo7pnu8h8'
    // If there are functions with "Image" PackageType in your template,
